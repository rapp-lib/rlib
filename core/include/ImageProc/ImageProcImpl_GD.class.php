...
//-------------------------------------
// 画像処理ライブラリのGD実装
class ImageProcImpl_GD {
	
	//-------------------------------------
	// 矩形に合わせてリサイズ
	protected function resize_boxed ($src_file, $dest_file, $options) {
		
		require_once(dirname(__FILE__)."/ImageProc/Zebra_Image.class.php");
		
		$image =new Zebra_Image;
		$image->source_path =$src_file;
